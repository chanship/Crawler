...
public class Controller {
    ...
    private final static String crawlSeed = "https://www.nytimes.com/";
    private final static int maxPageToFetch = 20000;
    private final static int maxDepthOfCrawling = 16;
    private final static String name = "Chanshin Park";
    ...
    public static CrawlController runCrawler() throws Exception {
        ...
        // start crawling
        nyCrawler.configure(crawlStorageFolder + "/files");
        crawlController.start(nyCrawler.class, numberOfCrawlers);
    ...
    public static void saveVisitCsv(CrawlState sumState) throws Exception {
        String fileName = crawlStorageFolder + "/visit_nytimes.csv";
        FileWriter writer = new FileWriter(fileName);

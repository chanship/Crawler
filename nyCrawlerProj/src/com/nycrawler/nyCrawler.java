...
public class nyCrawler extends WebCrawler {
	
	private static final Pattern FILTERS = Pattern.compile(".*\\.(css|js|xml|asc|puz|mp3|zip|gz)$");
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        String type="OutUSC";
        if(href.contains("www.nytimes.com"))
        {
        	type="OK";
        }
        else
